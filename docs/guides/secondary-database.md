...
!!! tip "Easy to forget"
    This second command is the step people miss. Without it, the
    `performance` app's tables simply don't exist on the secondary alias yet
    — the middleware will fail to write telemetry until you run it.
